        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($orders->isEmpty())
                <div class="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-700">No orders yet</h3>
                    <a href="{{ route('orders.create') }}" class="mt-4 inline-block px-5 py-2 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700">Place First Order</a>
                </div>
            @else
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Ship</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-sm font-semibold text-gray-900">${{ number_format($order->total_price, 2) }}</td>
                                <td class="px-6 py-4">
                                    @php
                                        $colors = ['pending'=>'yellow','confirmed'=>'blue','delivered'=>'green','cancelled'=>'red'];
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('orders.show', $order) }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
