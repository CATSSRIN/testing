                        ...
                        <table class="min-w-full divide-y divide-gray-50">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase whitespace-nowrap">{{ __('Ordered Qty') }}</th>
                                    <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase whitespace-nowrap">{{ __('Received Qty') }}</th>
                                </tr>
                            </thead>
